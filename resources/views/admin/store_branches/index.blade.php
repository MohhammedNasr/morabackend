    ...
    <div class="kt-subheader kt-grid__item" id="kt_subheader">
        <div class="kt-container kt-container--fluid">
            <div class="kt-subheader__main">
                <h3 class="kt-subheader__title">Store Branches</h3>
                <div class="kt-subheader__group">
                    {{-- <a href="{{ route('admin.stores.branches.create', ['store' => request('store')]) }}"
        ...
        <div class="kt-portlet kt-portlet--mobile">
            <div class="kt-portlet__body">
                ...
                <div class="table-responsive" style="max-height: 600px; overflow-y: auto; position: relative;">
                    <table class="table table-striped- table-bordered table-hover table-checkable" id="branches_table">
                        <style>
                            #branches_table thead th {
                                position: sticky;
                                top: 0;
                                background: white;
                                z-index: 1;
                            ...
                            #branches_table thead th:first-child {
                                z-index: 2;
                            }
                        </style>
                        <thead>
    ...
    <script>
        ...
        $(document).ready(function() {
            var table = $('#branches_table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('admin.stores.branches.datatable', request()->route('store')) }}",
                    type: "POST",
                    headers: {
