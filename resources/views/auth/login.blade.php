        ...
        <div class="kt-login__form"
            ...
            <div class="kt-login__title animate__animated animate__fadeInDown">
                <h3
                    ...
                    Welcome Back!</h3>
                <p class="kt-login__subtitle" style="color: rgba(255,255,255,0.8); margin-top: 0.5rem;">Sign in to continue
                </p>
            </div>
            ...
            <form method="POST" action="{{ route('store.login') }}" class="kt-form" novalidate="novalidate">
                @csrf

                <div class="form-group animate__animated animate__fadeInUp animate__delay-1s">
                    <input class="form-control" type="text" placeholder="Email" name="email"
                        value="{{ old('email') }}" required autofocus
                        style="background: rgba(255,255,255,0.1); border: 1px solid rgba(255,255,255,0.2); color: #fff; padding: 1rem; border-radius: 12px;">
                </div>
                ...
                <div class="kt-login__extra animate__animated animate__fadeInUp animate__delay-3s">
                    <label class="kt-checkbox" style="color: rgba(255,255,255,0.8);">
