    ...
    <div class="kt-login__body">
        <div class="kt-login__form"
            ...
            <div class="kt-login__title animate__animated animate__fadeInDown">
                    ...
                    مرحباً بعودتك!</h3>
                <p class="kt-login__subtitle" style="color: rgba(255,255,255,0.8); margin-top: 0.5rem;">سجل الدخول للمتابعة
                </p>
            </div>
            ...
            <form method="POST" action="{{ route('admin.login') }}" class="kt-form" novalidate="novalidate" style="text-align: right;">
                @csrf
...
<input class="form-control" type="password" placeholder="كلمة المرور" name="password" required
    style="background: rgba(0,0,0,0.1); border: 1px solid rgba(0,0,0,0.2); color: #000; padding: 1rem; border-radius: 12px;">
                ...
                <div class="kt-login__extra animate__animated animate__fadeInUp animate__delay-3s" style="display: flex; justify-content: space-between; align-items: center;">
                    <label class="kt-checkbox" style="color: #333; margin: 0; order: 2;">
